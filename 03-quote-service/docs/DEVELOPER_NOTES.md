...
| File                                                                                                                  | Role                                           | Notes                          |
|-----------------------------------------------------------------------------------------------------------------------|------------------------------------------------|--------------------------------|
| [`Quote.java`](../src/main/java/com/example/quoteservice/Quote.java)                                                 | Record for JSON response                       | Shared JSON shape with consumer |
| [`Value.java`](../src/main/java/com/example/quoteservice/Value.java)                                                 | Nested record (`id`, `quote` text)             | Shared JSON shape with consumer |
| [`QuoteController.java`](../src/main/java/com/example/quoteservice/QuoteController.java)                             | REST controller, serves quotes                 | Streams, `@PathVariable`, ThreadLocalRandom |
| [`QuoteServiceApplication.java`](../src/main/java/com/example/quoteservice/QuoteServiceApplication.java)             | Main Spring Boot application entry point       | Boots the app on port 8080     |
| [`application.properties`](../src/main/resources/application.properties)                                              | Configuration                                  | Default port 8080              |
| [`QuoteControllerTest.java`](../src/test/java/com/example/quoteservice/QuoteControllerTest.java)                     | Tests for all 3 endpoints                      | `@WebMvcTest`, MockMvc         |
...
Spring, through Jackson, uses this record to map the Java object
into JSON when the endpoints return it.
...
REST controller that serves quotes as JSON. See also [concepts/quote-controller.md](concepts/quote-controller.md) for detailed explanation.
...
### [QuoteControllerTest.java](../src/test/java/com/example/quoteservice/QuoteControllerTest.java)
